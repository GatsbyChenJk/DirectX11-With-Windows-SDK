...
void GameApp::UpdateScene(float dt)
{
    ...
    case GameApp::TessellationMode::Torus: UpdateTorus(); break;
    }
...
void GameApp::DrawScene()
{
    ...
    case GameApp::TessellationMode::Torus: DrawTorusSurface(); break;
    }
...
bool GameApp::InitResource()
{
    ...
    {
        XMFLOAT4(0.0f, 0.0f, 0.0f, m_TorusRadiusInside),
        XMFLOAT4(0.0f, 1.0f, 0.0f, m_TorusRadiusOutside),    
    };
    bufferDesc.ByteWidth = sizeof torusVertices;
    initData.pSysMem = torusVertices;
    HR(m_pd3dDevice->CreateBuffer(&bufferDesc, &initData, m_pTorusVB.GetAddressOf()));
    ...
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_Torus_VS", L"Shaders\\Tessellation_Torus_VS.hlsl",
        m_pd3dDevice.Get(), "VS", "vs_5_0"));
    ...
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_BezierSurface_HS", L"Shaders\\Tessellation_BezierSurface_HS.hlsl",
        m_pd3dDevice.Get(), "HS", "hs_5_0"));
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_Torus_HS", L"Shaders\\Tessellation_Torus_HS.hlsl",
        m_pd3dDevice.Get(), "HS", "hs_5_0"));
    ...
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_BezierSurface_DS", L"Shaders\\Tessellation_BezierSurface_DS.hlsl",
        m_pd3dDevice.Get(), "DS", "ds_5_0"));
    HR(m_pEffectHelper->CreateShaderFromFile("Tessellation_Torus_DS", L"Shaders\\Tessellation_Torus_DS.hlsl",
        m_pd3dDevice.Get(), "DS", "ds_5_0"));
    ...
    passDesc.nameVS = "Tessellation_Torus_VS";
    passDesc.nameHS = "Tessellation_Torus_HS";
    passDesc.nameDS = "Tessellation_Torus_DS";
    passDesc.namePS = "Tessellation_PS";
    HR(m_pEffectHelper->AddEffectPass("Tessellation_Torus", m_pd3dDevice.Get(), &passDesc));
    m_pEffectHelper->GetEffectPass("Tessellation_Torus")->SetRasterizerState(m_pRSWireFrame.Get());
